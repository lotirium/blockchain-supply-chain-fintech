...
async function grantStoreRoles() {
    try {
        console.log('Starting store role granting...');
        ...
        console.log('Store role granting completed');
    } catch (error) {
        console.error('Failed to grant store roles:', error);
        process.exit(1);
    }
}
